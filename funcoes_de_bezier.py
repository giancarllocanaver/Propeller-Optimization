...
class Bezier():
    def __init__(self, aerofolio_base=True, arquivo_base=''):
        ...
        if aerofolio_base == False:
            self.arquivo_coord_aerof = np.loadtxt(abrir_arquivo_aeerof,skiprows=linhas_a_pular)
    ...
    def gerar_bezier(self, tamanho_entre_pontos, retornar=False):
        ...
        self.linhas = np.reshape(self.linhas, (self.linhas.shape[0], self.linhas.shape[1]))
    ...
    def mudar_A(self, ponto, mudanca_x, mudanca_y, mudanca_adicional=True, retornar=False):
        """
